...
# Build directories
build_dir=${current_path}/build_wazuh
...
sed -i "s:DIR=\"/var/wazuhnet\":DIR=\"${dir_path}\":g" ${sources_dir}/debian/{preinst,postinst,prerm,postrm}
...
mv ${pkg_path}/${deb_file} ${current_path}/var/local/wazuh
